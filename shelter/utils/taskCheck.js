console.log(`%cShelter. week-3 - Добавление функционала при помощи JavaScript`, 'font-weight: bold; font-size: 18px');

console.log(`Task: https://github.com/rolling-scopes-school/tasks/blob/master/tasks/shelter/shelter-part3.md\n\n`);
...
console.log(`
  ...
  ✔️ 1. Реализация burger menu на обеих страницах: +26
  ...
  ✔️ 2. Реализация слайдера-карусели на странице Main: +36
  ...
  ✔️ 3. Реализация пагинации на странице Pets: +36
  ...
  ✔️ 4. Реализация попап на обеих страницах: +12
...
console.log(`%cИтого: 110 баллов из 110`, 'font-weight: bold; font-size: 18px');